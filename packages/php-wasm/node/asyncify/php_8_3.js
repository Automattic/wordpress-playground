...
export const dependenciesTotalSize = 15071192;
export function init(RuntimeName, PHPLoader) {
	...
	var wasmImports = {
		/** @export */ eb: _SharpYuvConvert,
		/** @export */ db: _SharpYuvGetConversionMatrix,
		/** @export */ cb: _SharpYuvInit,
		/** @export */ l: ___assert_fail,
		/** @export */ ga: __asyncjs__js_module_onMessage,
		...
		/** @export */ z: invoke_viiiiii,
		/** @export */ ia: invoke_viiiiiii,
		/** @export */ y: invoke_viiiiiiiii,
		/** @export */ F: _js_create_input_device,
		/** @export */ ha: js_fd_read,
		/** @export */ E: _js_open_process,
		/** @export */ fa: js_popen_to_file,
		/** @export */ ea: _js_process_status,
		/** @export */ da: _js_waitpid,
		/** @export */ U: _makecontext,
	...
	var _fflush = (a0) => (_fflush = wasmExports['rb'])(a0);

	var _wasm_read = (Module['_wasm_read'] = (a0, a1, a2) =>
		(_wasm_read = Module['_wasm_read'] = wasmExports['sb'])(a0, a1, a2));
	...
	var _emscripten_builtin_memalign = (a0, a1) =>
		(_emscripten_builtin_memalign = wasmExports['Qb'])(a0, a1);

	var __emscripten_timeout = (a0, a1) =>
		(__emscripten_timeout = wasmExports['Rb'])(a0, a1);

	var _setThrew = (a0, a1) => (_setThrew = wasmExports['Sb'])(a0, a1);

	var __emscripten_tempret_set = (a0) =>
		(__emscripten_tempret_set = wasmExports['Tb'])(a0);
	...
	var dynCall_iiiiiii = (Module['dynCall_iiiiiii'] = (
		...
		(dynCall_iiiiiii = Module['dynCall_iiiiiii'] = wasmExports['hc'])(
			a0,
			a1,
			a2,
			a3,
