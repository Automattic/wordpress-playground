...
export const dependenciesTotalSize = 15309871;
export function init(RuntimeName, PHPLoader) {
	...
	var wasmImports = {
		/** @export */ _a: _SharpYuvConvert,
		/** @export */ Za: _SharpYuvGetConversionMatrix,
		/** @export */ Ya: _SharpYuvInit,
		...
		/** @export */ Na: ___syscall_fdatasync,
		...
		/** @export */ ua: ___syscall_symlinkat,
	...
	var _wasm_read = (Module['_wasm_read'] = (a0, a1, a2) =>
		(_wasm_read = Module['_wasm_read'] = wasmExports['eb'])(a0, a1, a2));

	var _php_pollfd_for = (Module['_php_pollfd_for'] = (a0, a1, a2) =>
		(_php_pollfd_for = Module['_php_pollfd_for'] = wasmExports['fb'])(
			a0,
			a1,
			a2
		));
	...
	var _ntohs = (a0) => (_ntohs = wasmExports['kb'])(a0);

	var _htonl = (a0) => (_htonl = wasmExports['lb'])(a0);

	var _wasm_sleep = (Module['_wasm_sleep'] = (a0) =>
		(_wasm_sleep = Module['_wasm_sleep'] = wasmExports['mb'])(a0));

	var ___wrap_select = (Module['___wrap_select'] = (a0, a1, a2, a3, a4) =>
		(___wrap_select = Module['___wrap_select'] = wasmExports['nb'])(
			a0,
			a1,
			a2,
			a3,
	...
	var _wasm_add_cli_arg = (Module['_wasm_add_cli_arg'] = (a0) =>
		(_wasm_add_cli_arg = Module['_wasm_add_cli_arg'] = wasmExports['ob'])(
			a0
		));

	var _run_cli = (Module['_run_cli'] = () =>
		(_run_cli = Module['_run_cli'] = wasmExports['pb'])());
	...
	var _wasm_set_cookies = (Module['_wasm_set_cookies'] = (a0) =>
		(_wasm_set_cookies = Module['_wasm_set_cookies'] = wasmExports['Db'])(
			a0
		));
	...
	var _php_wasm_init = (Module['_php_wasm_init'] = () =>
		(_php_wasm_init = Module['_php_wasm_init'] = wasmExports['Hb'])());

	var _wasm_free = (Module['_wasm_free'] = (a0) =>
		(_wasm_free = Module['_wasm_free'] = wasmExports['Ib'])(a0));

	var ___funcs_on_exit = () => (___funcs_on_exit = wasmExports['Jb'])();

	var _emscripten_builtin_memalign = (a0, a1) =>
		(_emscripten_builtin_memalign = wasmExports['Kb'])(a0, a1);

	var __emscripten_timeout = (a0, a1) =>
		(__emscripten_timeout = wasmExports['Lb'])(a0, a1);

	var _setThrew = (a0, a1) => (_setThrew = wasmExports['Mb'])(a0, a1);

	var __emscripten_tempret_set = (a0) =>
		(__emscripten_tempret_set = wasmExports['Nb'])(a0);
	...
	var dynCall_vii = (Module['dynCall_vii'] = (a0, a1, a2) =>
		(dynCall_vii = Module['dynCall_vii'] = wasmExports['Sb'])(a0, a1, a2));

	var dynCall_viii = (Module['dynCall_viii'] = (a0, a1, a2, a3) =>
		(dynCall_viii = Module['dynCall_viii'] = wasmExports['Tb'])(
			a0,
			a1,
			a2,
			a3
	...
	var dynCall_iiiiiii = (Module['dynCall_iiiiiii'] = (
		...
		(dynCall_iiiiiii = Module['dynCall_iiiiiii'] = wasmExports['_b'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_viiiiiiiii = (Module['dynCall_viiiiiiiii'] = (
		...
		(dynCall_viiiiiiiii = Module['dynCall_viiiiiiiii'] = wasmExports['cc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_viiiiii = (Module['dynCall_viiiiii'] = (
		...
		(dynCall_viiiiii = Module['dynCall_viiiiii'] = wasmExports['dc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_iiiiiiii = (Module['dynCall_iiiiiiii'] = (
		...
		(dynCall_iiiiiiii = Module['dynCall_iiiiiiii'] = wasmExports['ec'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_iiiiiiiiii = (Module['dynCall_iiiiiiiiii'] = (
		...
		(dynCall_iiiiiiiiii = Module['dynCall_iiiiiiiiii'] = wasmExports['fc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_jii = (Module['dynCall_jii'] = (a0, a1, a2) =>
		(dynCall_jii = Module['dynCall_jii'] = wasmExports['gc'])(a0, a1, a2));

	var dynCall_viidii = (Module['dynCall_viidii'] = (a0, a1, a2, a3, a4, a5) =>
		(dynCall_viidii = Module['dynCall_viidii'] = wasmExports['hc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var _asyncify_start_unwind = (a0) =>
		(_asyncify_start_unwind = wasmExports['ic'])(a0);

	var _asyncify_stop_unwind = () =>
		(_asyncify_stop_unwind = wasmExports['jc'])();

	var _asyncify_start_rewind = (a0) =>
		(_asyncify_start_rewind = wasmExports['kc'])(a0);

	var _asyncify_stop_rewind = () =>
		(_asyncify_stop_rewind = wasmExports['lc'])();
