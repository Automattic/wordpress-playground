...
export const dependenciesTotalSize = 18695987;
export function init(RuntimeName, PHPLoader) {
	...
	var wasmImports = {
		/** @export */ db: _SharpYuvConvert,
		/** @export */ cb: _SharpYuvGetConversionMatrix,
		/** @export */ bb: _SharpYuvInit,
		/** @export */ n: ___assert_fail,
		/** @export */ fa: __asyncjs__js_module_onMessage,
		...
		/** @export */ ra: __emscripten_memcpy_js,
		...
		/** @export */ X: __mktime_js,
		/** @export */ W: __mmap_js,
		/** @export */ V: __munmap_js,
		/** @export */ J: __setitimer_js,
		/** @export */ oa: __tzset_js,
		/** @export */ $: _clock_time_get,
		...
		/** @export */ ha: invoke_viiiiiii,
		/** @export */ y: invoke_viiiiiiiii,
		/** @export */ E: _js_create_input_device,
		/** @export */ ga: js_fd_read,
		/** @export */ D: _js_open_process,
		/** @export */ ea: js_popen_to_file,
		/** @export */ da: _js_process_status,
		/** @export */ ca: _js_waitpid,
		/** @export */ T: _makecontext,
		/** @export */ ua: _proc_exit,
		/** @export */ S: _strptime,
		/** @export */ R: _swapcontext,
		/** @export */ r: _wasm_close,
		/** @export */ s: wasm_poll_socket,
		/** @export */ o: _wasm_setsockopt,
		/** @export */ Q: _wasm_shutdown,
	};
	...
	var _wasm_read = (Module['_wasm_read'] = (a0, a1, a2) =>
		(_wasm_read = Module['_wasm_read'] = wasmExports['rb'])(a0, a1, a2));
	...
	var __emscripten_tempret_set = (a0) =>
		(__emscripten_tempret_set = wasmExports['Sb'])(a0);

	var __emscripten_stack_restore = (a0) =>
		(__emscripten_stack_restore = wasmExports['Tb'])(a0);

	var __emscripten_stack_alloc = (a0) =>
		(__emscripten_stack_alloc = wasmExports['Ub'])(a0);

	var _emscripten_stack_get_current = () =>
		(_emscripten_stack_get_current = wasmExports['Vb'])();
	...
	var dynCall_v = (Module['dynCall_v'] = (a0) =>
		(dynCall_v = Module['dynCall_v'] = wasmExports['dc'])(a0));
	...
	var dynCall_iiiiiii = (Module['dynCall_iiiiiii'] = (
		...
		(dynCall_iiiiiii = Module['dynCall_iiiiiii'] = wasmExports['gc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_viidii = (Module['dynCall_viidii'] = (a0, a1, a2, a3, a4, a5) =>
		(dynCall_viidii = Module['dynCall_viidii'] = wasmExports['mc'])(
			a0,
			a1,
			a2,
			a3,
	...
	var _asyncify_start_unwind = (a0) =>
		(_asyncify_start_unwind = wasmExports['nc'])(a0);

	var _asyncify_stop_unwind = () =>
		(_asyncify_stop_unwind = wasmExports['oc'])();

	var _asyncify_start_rewind = (a0) =>
		(_asyncify_start_rewind = wasmExports['pc'])(a0);

	var _asyncify_stop_rewind = () =>
		(_asyncify_stop_rewind = wasmExports['qc'])();
